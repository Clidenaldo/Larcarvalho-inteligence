...
if (
  ...
  throw new Error('Public theme E2E requires the local test database');

export default defineConfig({
  testDir: './tests/public-theme',
  workers: 1,
  fullyParallel: false,
  timeout: 120000,
  expect: { timeout: 15000 },
  reporter: 'list',
  outputDir: 'test-results/public-theme',
  use: {
  ...
  webServer: [
    {
      ...
      url: 'http://localhost:3101/api/v1/ready',
    ...
    },
    {
      ...
      env: {
        ...process.env,
        BACKEND_INTERNAL_URL: 'http://localhost:3101',
